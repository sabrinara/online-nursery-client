...
const ProductCard = ({ products }: { products: TProducts }) => {
    ...
    //         description: "Leopard Lily is known for its striking spotted leaves and easy maintenance, making it a popular choice for indoor spaces."
    //     },
    //     {
    //          quantity: 2,
    ...
    //         rating: 3.5,
    //         category: "Indoor plant",
    //         description: "This variety plant offers a mix of textures and colors, perfect for adding diversity and vibrancy to any room."
    //     },
    //     {
    //          quantity: 2,
    ...
    //         description: "The Green Foliage plant is admired for its lush, vibrant leaves that add a refreshing, natural touch to any space."
    //     },
    //     {
    //          quantity: 5,
    ...
    //         description: "Decorative grass brings a touch of nature indoors with its sleek and minimalist design, perfect for modern interiors."
    //     },
    //     {
    //          quantity: 2,
    ...
    //         price: 20,
    //         rating: 5,
    //         description: "Saculla plants are known for their lush green foliage and are often gifted for their elegance and easy care."
    //     },
    //     {
    //          quantity: 2,
    ...
    //         price: 25,
    //         rating: 5,
    //         description: "Spring plants bring a refreshing vibe to office spaces with their bright green leaves and minimal upkeep requirements."
    //     },
    //     {
    //          quantity: 4,
    ...
    //         rating: 1,
    //         category: "Indoor plant",
    //         description: "Bonsai is the Japanese art of cultivating miniature trees, emphasizing patience, balance, and natural beauty."
    //     },
    //     {
    //          quantity: 1,
    ...
    //         rating: 1,
    //         category: "Outdoor plant",
    //         description: "Westwood Gardens succulents are known for their hardy, low-maintenance plants that thrive in various environments. They are perfect for beginners and seasoned gardeners."
    //     },
    //     {
    //          quantity: 2,
    ...
    //         rating: 1,
    //         category: "Outdoor plant",
    //         description: "Tulip flowers are a favorite choice for gardeners, offering bright colors and graceful shapes that enhance outdoor spaces."
    //     }
    // ];
